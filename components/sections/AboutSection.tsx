...
export default function AboutSection() {
  return (
    <section className='mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-2'>
      <div>
        <h2 className='font-[family-name:var(--font-space)] text-4xl font-bold text-slate-100'>Built for critical infrastructure.</h2>
      ...
      <div className='group relative rounded-2xl border border-cyan-400/20 bg-[#0f1420] p-6 shadow-[0_0_40px_rgba(0,180,240,.08)]'>
        ...
        <div className='relative h-80 overflow-hidden rounded-xl border border-cyan-400/15'>
          <Image
            src='/images/infrastructure/rightSide.png'
            alt='Infrastructure operations visualization'
            fill
            sizes='(max-width: 1024px) 100vw, 50vw'
            className='object-cover transition duration-700 group-hover:scale-[1.035] group-hover:saturate-125'
            priority={false}
          />
